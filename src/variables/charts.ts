...
export const lineChartDataOverallRevenue = [
  {
    name: 'Success',
    data: [50, 64, 48, 66, 49, 68, 60, 70, 80, 90, 100, 110],
  },
  {
    name: 'Failed',
    data: [30, 40, 24, 46, 20, 46, 40, 50, 60, 70, 80, 90],
  },
  {
    name: 'Total',
    data: [80, 104, 72, 112, 69, 114, 100, 120, 140, 160, 180, 200],
  },
];
...
export const lineChartOptionsProjectStatus = {
  ...
  xaxis: {
    categories: ['06', '08', '10', '12', '14', '16', '18'],
    labels: {
      style: {
        colors: '#A3AED0',
        fontSize: '14px',
...
export const pieChartOptions = {
  labels: ['HL7', 'DICOM', 'JSON'],
  colors: ['#4318FF', '#6AD2FF', '#00FF00'],
  chart: {
    width: '50px',
  },
  states: {
